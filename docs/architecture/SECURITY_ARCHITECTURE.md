...
| T3 | **Replayed request** (old commit/reveal re-sent) | TB-1 | turn-cursor guard `(sub_game, step, phase)`; idempotency | cursor mismatch | `E-PROTO-STALE`, ignore | rejected id + cursor |
