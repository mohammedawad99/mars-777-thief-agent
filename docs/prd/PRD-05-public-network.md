...
| **PRD05-FR-034a** | **[CLOSE-F1]** It **MUST NOT** be represented as a field of `declaration_<game_id>.json`. The locked 16-field declaration contract contains **no series-convention slot**, and **no field may be added**: the official four-artifact matrix stays at **75** (declaration 16 / config 39 / log 9 / result 11) and **no new JDEC is created** for this. | **ARCHITECTURE-CONSTRAINT**; FIELD_MATRIX (locked) |
